...
BOOST_AUTO_TEST_CASE(forwardArrayBounds)
{
    ...
    // overruns
    cq_float *in = new cq_float[4];
    in[0] = 1;
    in[1] = 1;
    in[2] = -1;
    in[3] = -1;
    cq_float re[] = { 999, 999, 999, 999, 999, 999 };
    cq_float im[] = { 999, 999, 999, 999, 999, 999 };
...
BOOST_AUTO_TEST_CASE(inverseArrayBounds)
{
    ...
    // so that, if running under valgrind, we get warnings about
    // overruns
    cq_float *re = new cq_float[4];
    cq_float *im = new cq_float[4];
    re[0] = 0;
    re[1] = 1;
    re[2] = 0;
    re[3] = 1;
    ...
    im[2] = 0;
    im[3] = 2;
    cq_float outre[] = { 999, 999, 999, 999, 999, 999 };
    cq_float outim[] = { 999, 999, 999, 999, 999, 999 };
...
BOOST_AUTO_TEST_CASE(r_inverseArrayBounds)
{
    ...
    // so that, if running under valgrind, we get warnings about
    // overruns
    cq_float *re = new cq_float[3];
    cq_float *im = new cq_float[3];
    re[0] = 0;
    re[1] = 1;
    re[2] = 0;
    im[0] = 0;
...
BOOST_AUTO_TEST_CASE(dc)
{
    ...
    cq_float in[] = { 1, 1, 1, 1 };
    cq_float re[] = { 999, 999, 999, 999 };
    cq_float im[] = { 999, 999, 999, 999 };
...
{
    // DC-only signal. The DC bin is purely real
    cq_float rin[] = { 1, 1, 1, 1 };
    cq_float iin[] = { 1, 1, 1, 1 };
    cq_float re[] = { 999, 999, 999, 999 };
    cq_float im[] = { 999, 999, 999, 999 };
...
{
    // Cosine. Output is purely real
    cq_float rin[] = { 1, 0, -1, 0 };
    cq_float iin[] = { 1, 0, -1, 0 };
    cq_float re[] = { 999, 999, 999, 999 };
    cq_float im[] = { 999, 999, 999, 999 };
    FFT(4).process(false, rin, iin, re, im);
    BOOST_CHECK_EQUAL(re[0], 0.0);
...
BOOST_AUTO_TEST_CASE(sizes) 
{
    ...
    cq_float in[] = { 1, 1, 1 };
    cq_float re[] = { 999, 999, 999 };
    cq_float im[] = { 999, 999, 999 };
